        ...
        if (state) {
            return (
                <>
                    ...
                    <li className="nav-item">
                        <NavLink exact activeClassName="active-page" className="nav-link" to="/Placed">Placed</NavLink>
                    </li>
                    <li className="nav-item">
                        <NavLink exact activeClassName="active-page" className="nav-link" to="/Credits">Credits</NavLink>
                    </li>
                    <li className="nav-item">
